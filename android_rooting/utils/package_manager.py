...
class TermuxPackageManager:
    ...
    def _run_pkg_command(self, command: List[str], timeout: int = 60) -> Tuple[bool, str, str]:
    ...
    def install_package(self, package_name: str) -> bool:
        ...
        success, stdout, stderr = self._run_pkg_command(['install', termux_package, '-y'])
    ...
    def is_package_installed(self, package_name: str) -> bool:
        ...
        termux_package = self.package_mappings.get(package_name, package_name)
        success, stdout, stderr = self._run_pkg_command(['list-installed', termux_package])
    ...
    def remove_package(self, package_name: str) -> bool:
        ...
        success, stdout, stderr = self._run_pkg_command(['uninstall', termux_package, '-y'])
...
if __name__ == "__main__":
    ...
    parser.add_argument('action', choices=['install', 'remove', 'search', 'info', 'list', 'setup'],
                       help='Action to perform')
    parser.add_argument('packages', nargs='*', help='Package names')
    parser.add_argument('--update', action='store_true', help='Update package lists first')
    parser.add_argument('--python', action='store_true', help='Use Python pip instead of pkg')
