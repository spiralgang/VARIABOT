...
class TermuxEnvironment:
    ...
    def _detect_termux(self) -> bool:
        ...
        termux_indicators = [
            ...
            "PREFIX" in self.env_vars
            and "/data/data/com.termux/files/usr" in self.env_vars.get("PREFIX", ""),
    ...
    def _get_android_info(self) -> Dict[str, Any]:
        ...
        android_info = {
            ...
            "is_external_storage": self.env_vars.get(
            ...
            profile.update(
                {
                    ...
                    "storage_path": self.termux_info.get(
    ...
    def get_optimal_model_config(self) -> Dict[str, Any]:
        ...
        if not self.termux_detected:
            return {"model_size": "standard", "quantization": False, "device": "cpu"}
            ...
            optimizations.update(
                {
                    ...
                    "VARIABOT_CPU_THREADS": str(
                        self.optimization_profile["cpu_threads"]
                    ),
