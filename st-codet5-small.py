...
### START STREAMLIT UI
st.set_page_config(page_title="VARIABOT - CodeT5-Small", page_icon="🤖", layout="wide")

st.image(
    "https://github.com/fabiomatricardi/ChatBOTMastery/raw/main/codet5logo.png",
    width=600,
)
st.markdown(
    "### *CodeT5-Small: Lightweight Code Assistant (880MB)*", unsafe_allow_html=True
)
st.markdown("---")
